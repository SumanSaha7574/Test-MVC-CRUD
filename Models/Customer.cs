...
namespace Test_MVC_CRUD.Models
{
    public class Customer
    {
        ...
        [StringLength(50, ErrorMessage = "Name should be less than or equal to 10 characters.")]
        ...
        [Test_MVC_CRUD.Models.CustomValidationAttributeDemo.ValidBirthDate(ErrorMessage = "Birth Date can not be greater than current date")]
